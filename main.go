...
import (
	...
	"github.com/nemoworks/dl-experiment/controllers"
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:   "20e2c3e0.njuics.cn",
	})
	if err != nil {
	...
	// create experiment reconciler
	experimentReconciler, err := controllers.NewDLExperimentReconciler(mgr)
	if err != nil {
	...
	if err = experimentReconciler.SetupWithManager(mgr); err != nil {
		setupLog.Error(err, "unable to create controller", "controller", "DLExperiment")
		os.Exit(1)
	}
